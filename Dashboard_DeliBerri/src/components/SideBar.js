...
function SideBar() {
  ...
  return (
    <React.Fragment>
      {/*<!-- Sidebar -->*/}
      <ul
        className="navbar-nav bg-pink bg-gradient sidebar sidebar-dark accordion "
        style={sideBarStyle}
        id="accordionSidebar"
      >
        {/*<!-- Sidebar - Brand -->*/}
        ...
        <li className="nav-item">
          <Link className="nav-link collapsed" to="/categories-in-db">
